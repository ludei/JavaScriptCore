...
EncodedJSValue JSC_HOST_CALL mathProtoFuncIMul(ExecState*);
    ...
    EncodedJSValue JSC_HOST_CALL idtkProtoFuncSave               (ExecState*);
    EncodedJSValue JSC_HOST_CALL idtkProtoFuncRestore            (ExecState*);
    EncodedJSValue JSC_HOST_CALL idtkProtoFuncDrawImage          (ExecState*);
    EncodedJSValue JSC_HOST_CALL idtkProtoFuncTranslate          (ExecState*);
    EncodedJSValue JSC_HOST_CALL idtkProtoFuncScale              (ExecState*);
    EncodedJSValue JSC_HOST_CALL idtkProtoFuncRotate         (ExecState*);
    EncodedJSValue JSC_HOST_CALL idtkProtoFuncSetTransform   (ExecState*);
    EncodedJSValue JSC_HOST_CALL idtkProtoFuncTransform      (ExecState*);
    EncodedJSValue JSC_HOST_CALL idtkProtoFuncLineTo         (ExecState*);
    EncodedJSValue JSC_HOST_CALL idtkProtoFuncMoveTo             (ExecState*);
    EncodedJSValue JSC_HOST_CALL idtkProtoFuncBeginPath          (ExecState*);
    EncodedJSValue JSC_HOST_CALL idtkProtoFuncBezierCurveTo      (ExecState*);
    EncodedJSValue JSC_HOST_CALL idtkProtoFuncQuadraticCurveTo(ExecState*);
    EncodedJSValue JSC_HOST_CALL idtkProtoFuncFill               (ExecState*);
    EncodedJSValue JSC_HOST_CALL idtkProtoFuncStroke             (ExecState*);
    EncodedJSValue JSC_HOST_CALL idtkProtoFuncClosePath          (ExecState*);
    EncodedJSValue JSC_HOST_CALL idtkProtoFuncFillRect           (ExecState*);
    EncodedJSValue JSC_HOST_CALL idtkProtoFuncStrokeRect         (ExecState*);
    EncodedJSValue JSC_HOST_CALL idtkProtoFuncRect               (ExecState*);
    EncodedJSValue JSC_HOST_CALL idtkProtoFuncArc                (ExecState*);
    EncodedJSValue JSC_HOST_CALL idtkProtoFuncArcTo              (ExecState*);
    EncodedJSValue JSC_HOST_CALL idtkProtoFuncClip               (ExecState*);

}

extern void IDTKCanvasSave(void * thisData);
extern void IDTKCanvasRestore(void * thisData);
extern void IDTKCanvasDrawImage(void * thisData, void * image, double x, double y);
extern void IDTKCanvasDrawImage(void * thisData, void * image, double x, double y, double w, double h);
extern void IDTKCanvasDrawImage(void * thisData, void * image, double sx, double sy, double sw, double sh, double dx, double dy, double dw, double dh);
extern void IDTKCanvasTranslate(void * thisData, double x, double y);
extern void IDTKCanvasScale(void * thisData, double x, double y);
extern void IDTKCanvasRotate(void * thisData, double angle);
extern void IDTKCanvasSetTransform(void * thisData, double m00, double m10, double m01, double m11, double m02, double m12);
extern void IDTKCanvasTransform(void * thisData, double m00, double m10, double m01, double m11, double m02, double m12);
extern void IDTKCanvasLineTo(void * thisData, double x, double y);
extern void IDTKCanvasMoveTo(void * thisData, double x, double y);
extern void IDTKCanvasBeginPath(void * thisData, double x, double y);
extern void IDTKCanvasBeginPath(void * thisData);
extern void IDTKCanvasBezierCurveTo(void * thisData, double cpx1, double cpy1, double cpx2, double cpy2, double x, double y);
extern void IDTKCanvasQuadraticCurveTo(void * thisData, double cpx1, double cpy1, double x, double y);
extern void IDTKCanvasFill(void * thisData);
extern void IDTKCanvasStroke(void * thisData);
extern void IDTKCanvasFill(void * thisData, void * pathData);
extern void IDTKCanvasStroke(void * thisData, void * pathData);
extern void IDTKCanvasClosePath(void * thisData);
extern void IDTKCanvasFillRect(void * thisData, double x, double y, double w, double h);
extern void IDTKCanvasStrokeRect(void * thisData, double x, double y, double w, double h);
extern void IDTKCanvasRect(void * thisData, double x, double y, double w, double h);
extern void IDTKCanvasArc(void * thisData, double x, double y, double radius, double startAngle, double endAngle, bool clockwise);
extern void IDTKCanvasArcTo(void * thisData, double x1, double y1, double x2, double y2, double radius);
extern void IDTKCanvasClip(void * thisData);
...
void MathObject::finishCreation(VM& vm, JSGlobalObject* globalObject)
{
    ...
    /*
     idtksave          idtkProtoFuncSave                   DontEnum|Function 0
     idtkrestore       idtkProtoFuncRestore                DontEnum|Function 0
     idtkdrawimage     idtkProtoFuncDrawImage              DontEnum|Function 9
     idtktranslate     idtkProtoFuncTranslate              DontEnum|Function 2
     idtkscale         idtkProtoFuncScale                  DontEnum|Function 2
     idtkrotate        idtkProtoFuncRotate                 DontEnum|Function 1
     idtksettransform  idtkProtoFuncSetTransform           DontEnum|Function 6
     idtktransform     idtkProtoFuncTransform              DontEnum|Function 6
     idtklineto        idtkProtoFuncLineTo                 DontEnum|Function 2
     idtkmoveto        idtkProtoFuncMoveTo                 DontEnum|Function 2
     idtkbeginpath     idtkProtoFuncBeginPath              DontEnum|Function 2
     idtkbeziercurveto idtkProtoFuncBezierCurveTo          DontEnum|Function 6
     idtkquadraticcurveto idtkProtoFuncQuadraticCurveTo    DontEnum|Function 4
     idtkfill          idtkProtoFuncFill                   DontEnum|Function 0
     idtkstroke        idtkProtoFuncStroke                 DontEnum|Function 0
     idtkclosepath     idtkProtoFuncClosePath              DontEnum|Function 0
     idtkfillrect      idtkProtoFuncFillRect               DontEnum|Function 4
     idtkstrokerect    idtkProtoFuncStrokeRect             DontEnum|Function 4
     idtkrect          idtkProtoFuncRect                   DontEnum|Function 4
     idtkarc           idtkProtoFuncArc                    DontEnum|Function 6
     idtkarcto         idtkProtoFuncArcTo                  DontEnum|Function 5
     idtkclip          idtkProtoFuncClip                   DontEnum|Function 0
     */
    putDirectNativeFunctionWithoutTransition(vm, globalObject, Identifier(&vm, "idtksave"), 0, idtkProtoFuncSave, NoIntrinsic, DontEnum | Function);
    putDirectNativeFunctionWithoutTransition(vm, globalObject, Identifier(&vm, "idtkrestore"), 0, idtkProtoFuncRestore, NoIntrinsic, DontEnum | Function);
    putDirectNativeFunctionWithoutTransition(vm, globalObject, Identifier(&vm, "idtkdrawimage"), 9, idtkProtoFuncDrawImage, NoIntrinsic, DontEnum | Function);
    putDirectNativeFunctionWithoutTransition(vm, globalObject, Identifier(&vm, "idtktranslate"), 2, idtkProtoFuncTranslate, NoIntrinsic, DontEnum | Function);
    putDirectNativeFunctionWithoutTransition(vm, globalObject, Identifier(&vm, "idtkscale"), 2, idtkProtoFuncScale, NoIntrinsic, DontEnum | Function);
    putDirectNativeFunctionWithoutTransition(vm, globalObject, Identifier(&vm, "idtkrotate"), 1, idtkProtoFuncRotate, NoIntrinsic, DontEnum | Function);
    putDirectNativeFunctionWithoutTransition(vm, globalObject, Identifier(&vm, "idtksettransform"), 6, idtkProtoFuncSetTransform, NoIntrinsic, DontEnum | Function);
    putDirectNativeFunctionWithoutTransition(vm, globalObject, Identifier(&vm, "idtktransform"), 6, idtkProtoFuncTransform, NoIntrinsic, DontEnum | Function);
    putDirectNativeFunctionWithoutTransition(vm, globalObject, Identifier(&vm, "idtklineto"), 2, idtkProtoFuncLineTo, NoIntrinsic, DontEnum | Function);
    putDirectNativeFunctionWithoutTransition(vm, globalObject, Identifier(&vm, "idtkmoveto"), 2, idtkProtoFuncMoveTo, NoIntrinsic, DontEnum | Function);
    putDirectNativeFunctionWithoutTransition(vm, globalObject, Identifier(&vm, "idtkbeginpath"), 2, idtkProtoFuncBeginPath, NoIntrinsic, DontEnum | Function);
    putDirectNativeFunctionWithoutTransition(vm, globalObject, Identifier(&vm, "idtkbeziercurveto"), 6, idtkProtoFuncBezierCurveTo, NoIntrinsic, DontEnum | Function);
    putDirectNativeFunctionWithoutTransition(vm, globalObject, Identifier(&vm, "idtkquadraticcurveto"), 4, idtkProtoFuncQuadraticCurveTo, NoIntrinsic, DontEnum | Function);
    putDirectNativeFunctionWithoutTransition(vm, globalObject, Identifier(&vm, "idtkfill"), 0, idtkProtoFuncFill, NoIntrinsic, DontEnum | Function);
    putDirectNativeFunctionWithoutTransition(vm, globalObject, Identifier(&vm, "idtkstroke"), 0, idtkProtoFuncStroke, NoIntrinsic, DontEnum | Function);
    putDirectNativeFunctionWithoutTransition(vm, globalObject, Identifier(&vm, "idtkclosepath"), 0, idtkProtoFuncClosePath, NoIntrinsic, DontEnum | Function);
    putDirectNativeFunctionWithoutTransition(vm, globalObject, Identifier(&vm, "idtkfillrect"), 4, idtkProtoFuncFillRect, NoIntrinsic, DontEnum | Function);
    putDirectNativeFunctionWithoutTransition(vm, globalObject, Identifier(&vm, "idtkstrokerect"), 4, idtkProtoFuncStrokeRect, NoIntrinsic, DontEnum | Function);
    putDirectNativeFunctionWithoutTransition(vm, globalObject, Identifier(&vm, "idtkrect"), 4, idtkProtoFuncRect, NoIntrinsic, DontEnum | Function);
    putDirectNativeFunctionWithoutTransition(vm, globalObject, Identifier(&vm, "idtkarc"), 6, idtkProtoFuncArc, NoIntrinsic, DontEnum | Function);
    putDirectNativeFunctionWithoutTransition(vm, globalObject, Identifier(&vm, "idtkarcto"), 5, idtkProtoFuncArcTo, NoIntrinsic, DontEnum | Function);
    putDirectNativeFunctionWithoutTransition(vm, globalObject, Identifier(&vm, "idtkclip"), 0, idtkProtoFuncClip, NoIntrinsic, DontEnum | Function);
    
}
    
// IDTK
    
    inline void * getObjectPrivateData(JSObject * jsObject)
    {
    ...
    EncodedJSValue JSC_HOST_CALL idtkProtoFuncSave(ExecState* exec)
    {
        void * data = getObjectPrivateData(exec->thisValue().toObject(exec));
        IDTKCanvasSave(data);
        return NULL;//JSValue::encode(jsUndefined());
    }
    
    EncodedJSValue JSC_HOST_CALL idtkProtoFuncRestore(ExecState* exec)
    {
        void * data = getObjectPrivateData(exec->thisValue().toObject(exec));
        IDTKCanvasRestore(data);
        return NULL;//JSValue::encode(jsUndefined());
    }
    
    EncodedJSValue JSC_HOST_CALL idtkProtoFuncDrawImage(ExecState* exec)
    {
        void * data = getObjectPrivateData(exec->thisValue().toObject(exec));
        ...
        {
            case 1: {
                void * texture = getObjectPrivateData(exec->argument(0).toObject(exec));
                IDTKCanvasDrawImage(data, texture,0,0);
                break;
            }
            case 3 : {
                void * texture = getObjectPrivateData(exec->argument(0).toObject(exec));
                IDTKCanvasDrawImage(data, texture, exec->argument(1).toNumber(exec), exec->argument(2).toNumber(exec));
                break;
            }
            case 5: {
                void * texture = getObjectPrivateData(exec->argument(0).toObject(exec));
                IDTKCanvasDrawImage(data, texture,  exec->argument(1).toNumber(exec), exec->argument(2).toNumber(exec),
                                    exec->argument(3).toNumber(exec), exec->argument(4).toNumber(exec));
                break;
            }
            case 9: {
                void * texture = getObjectPrivateData(exec->argument(0).toObject(exec));
                IDTKCanvasDrawImage(data, texture, exec->argument(1).toNumber(exec), exec->argument(2).toNumber(exec),
                                    exec->argument(3).toNumber(exec), exec->argument(4).toNumber(exec),exec->argument(5).toNumber(exec), exec->argument(6).toNumber(exec),
                                    exec->argument(7).toNumber(exec), exec->argument(8).toNumber(exec));
    ...
    EncodedJSValue JSC_HOST_CALL idtkProtoFuncTranslate(ExecState* exec)
    {
        void * data = getObjectPrivateData(exec->thisValue().toObject(exec));
        IDTKCanvasTranslate(data, exec->argument(0).toNumber(exec), exec->argument(1).toNumber(exec));
        return NULL;//JSValue::encode(jsUndefined());
    }
    
    EncodedJSValue JSC_HOST_CALL idtkProtoFuncScale(ExecState* exec)
    {
        void * data = getObjectPrivateData(exec->thisValue().toObject(exec));
        IDTKCanvasScale(data, exec->argument(0).toNumber(exec), exec->argument(1).toNumber(exec));
        return NULL;//JSValue::encode(jsUndefined());
    }
    
    EncodedJSValue JSC_HOST_CALL idtkProtoFuncRotate(ExecState* exec)
    {
        void * data = getObjectPrivateData(exec->thisValue().toObject(exec));
        IDTKCanvasRotate(data, exec->argument(0).toNumber(exec));
        return NULL;//JSValue::encode(jsUndefined());
    }
    
    EncodedJSValue JSC_HOST_CALL idtkProtoFuncSetTransform(ExecState* exec)
    {
        void * data = getObjectPrivateData(exec->thisValue().toObject(exec));
        IDTKCanvasSetTransform(data, exec->argument(0).toNumber(exec),exec->argument(1).toNumber(exec),exec->argument(2).toNumber(exec),exec->argument(3).toNumber(exec),
                               exec->argument(4).toNumber(exec),exec->argument(5).toNumber(exec) );
        return NULL;//JSValue::encode(jsUndefined());
    }
    
    EncodedJSValue JSC_HOST_CALL idtkProtoFuncTransform(ExecState* exec)
    {
        void * data = getObjectPrivateData(exec->thisValue().toObject(exec));
        IDTKCanvasTransform(data, exec->argument(0).toNumber(exec),exec->argument(1).toNumber(exec),exec->argument(2).toNumber(exec),exec->argument(3).toNumber(exec),
                            exec->argument(4).toNumber(exec),exec->argument(5).toNumber(exec) );
        return NULL;//JSValue::encode(jsUndefined());
    }
    
    EncodedJSValue JSC_HOST_CALL idtkProtoFuncLineTo(ExecState* exec)
    {
        void * data = getObjectPrivateData(exec->thisValue().toObject(exec));
        IDTKCanvasLineTo(data, exec->argument(0).toNumber(exec), exec->argument(1).toNumber(exec));
        return NULL;//JSValue::encode(jsUndefined());
    }
    
    EncodedJSValue JSC_HOST_CALL idtkProtoFuncMoveTo(ExecState* exec)
    {
        void * data = getObjectPrivateData(exec->thisValue().toObject(exec));
        IDTKCanvasMoveTo(data, exec->argument(0).toNumber(exec), exec->argument(1).toNumber(exec));
        return NULL;//JSValue::encode(jsUndefined());
    }
    
    EncodedJSValue JSC_HOST_CALL idtkProtoFuncBeginPath(ExecState* exec)
    {
        void * data = getObjectPrivateData(exec->thisValue().toObject(exec));
        if (exec->argumentCount() > 1)
            IDTKCanvasBeginPath(data, exec->argument(0).toNumber(exec), exec->argument(1).toNumber(exec));
        else
            IDTKCanvasBeginPath(data);
        return NULL;//JSValue::encode(jsUndefined());
    }
    
    EncodedJSValue JSC_HOST_CALL idtkProtoFuncBezierCurveTo(ExecState* exec)
    {
        void * data = getObjectPrivateData(exec->thisValue().toObject(exec));
        IDTKCanvasBezierCurveTo(data, exec->argument(0).toNumber(exec), exec->argument(1).toNumber(exec), exec->argument(2).toNumber(exec),
                                exec->argument(3).toNumber(exec), exec->argument(4).toNumber(exec), exec->argument(5).toNumber(exec));
        return NULL;//JSValue::encode(jsUndefined());
    }
    
    EncodedJSValue JSC_HOST_CALL idtkProtoFuncQuadraticCurveTo(ExecState* exec)
    {
        void * data = getObjectPrivateData(exec->thisValue().toObject(exec));
        IDTKCanvasQuadraticCurveTo(data, exec->argument(0).toNumber(exec), exec->argument(1).toNumber(exec), exec->argument(2).toNumber(exec),
                                   exec->argument(3).toNumber(exec));
        return NULL;//JSValue::encode(jsUndefined());
    }
    
    EncodedJSValue JSC_HOST_CALL idtkProtoFuncFill(ExecState* exec)
    {
        void * data = getObjectPrivateData(exec->thisValue().toObject(exec));
        IDTKCanvasFill(data);
        return NULL;//JSValue::encode(jsUndefined());
    ...
    EncodedJSValue JSC_HOST_CALL idtkProtoFuncStroke(ExecState* exec)
    {
        void * data = getObjectPrivateData(exec->thisValue().toObject(exec));
        IDTKCanvasStroke(data);
        return NULL;//JSValue::encode(jsUndefined());
    }
    
    EncodedJSValue JSC_HOST_CALL idtkProtoFuncClosePath(ExecState* exec)
    {
        void * data = getObjectPrivateData(exec->thisValue().toObject(exec));
        IDTKCanvasClosePath(data);
        return NULL;//JSValue::encode(jsUndefined());
    }
    
    EncodedJSValue JSC_HOST_CALL idtkProtoFuncClip(ExecState* exec)
    {
        void * data = getObjectPrivateData(exec->thisValue().toObject(exec));
        IDTKCanvasClip(data);
        return NULL;//JSValue::encode(jsUndefined());
    ...
    EncodedJSValue JSC_HOST_CALL idtkProtoFuncFillRect(ExecState* exec)
    {
        void * data = getObjectPrivateData(exec->thisValue().toObject(exec));
        IDTKCanvasFillRect(data, exec->argument(0).toNumber(exec), exec->argument(1).toNumber(exec), exec->argument(2).toNumber(exec),
                           exec->argument(3).toNumber(exec));
        return NULL;//JSValue::encode(jsUndefined());
    }
    
    EncodedJSValue JSC_HOST_CALL idtkProtoFuncStrokeRect(ExecState* exec)
    {
        void * data = getObjectPrivateData(exec->thisValue().toObject(exec));
        IDTKCanvasStrokeRect(data, exec->argument(0).toNumber(exec), exec->argument(1).toNumber(exec), exec->argument(2).toNumber(exec),
                             exec->argument(3).toNumber(exec));
        return NULL;//JSValue::encode(jsUndefined());
    }
    
    EncodedJSValue JSC_HOST_CALL idtkProtoFuncRect(ExecState* exec)
    {
        void * data = getObjectPrivateData(exec->thisValue().toObject(exec));
        IDTKCanvasRect(data, exec->argument(0).toNumber(exec), exec->argument(1).toNumber(exec), exec->argument(2).toNumber(exec),
                       exec->argument(3).toNumber(exec));
        return NULL;//JSValue::encode(jsUndefined());
    }
    
    EncodedJSValue JSC_HOST_CALL idtkProtoFuncArc(ExecState* exec)
    {
        void * data = getObjectPrivateData(exec->thisValue().toObject(exec));
        IDTKCanvasArc(data, exec->argument(0).toNumber(exec), exec->argument(1).toNumber(exec), exec->argument(2).toNumber(exec),
                      exec->argument(3).toNumber(exec), exec->argument(4).toNumber(exec), exec->argument(5).toNumber(exec));
        return NULL;//JSValue::encode(jsUndefined());
    }
    
    EncodedJSValue JSC_HOST_CALL idtkProtoFuncArcTo(ExecState* exec)
    {
        void * data = getObjectPrivateData(exec->thisValue().toObject(exec));
        IDTKCanvasArcTo(data, exec->argument(0).toNumber(exec), exec->argument(1).toNumber(exec), exec->argument(2).toNumber(exec),
                        exec->argument(3).toNumber(exec), exec->argument(4).toNumber(exec));
        return NULL;//JSValue::encode(jsUndefined());
    }
